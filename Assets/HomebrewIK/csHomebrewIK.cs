...
namespace FischlWorks
{
    ...
    public class csHomebrewIK : MonoBehaviour
    {
        ...
        public bool EnableIKPositioning { get => enableIKPositioning; set => enableIKPositioning = value; }
        public bool EnableIKRotating { get => enableIKRotating; set => enableIKRotating = value; }
        public float GlobalWeight { get => globalWeight; set => globalWeight = value; }
